		...
		>
			<div class="carousel-wrap">
				<div class="carousel-caption">
					...
					<el-button type="warning" size="large" round @click="goFile">
						{{ item.btn }}
					</el-button>
...
import bannerImg from '/images/home/banner/banner1.png'
 ...
 */
const goFile = () => {
	router.push({ name: 'File', query: { filePath: '/', fileType: 0 } })
}
</script>
